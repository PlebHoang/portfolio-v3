...
const liquidbuttonVariants = cva(
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,box-shadow,transform] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "bg-transparent hover:scale-[1.02] duration-300 transition text-neutral-900",
        dark: "bg-black/90 text-white hover:scale-[1.02] duration-300 transition",
        destructive:
      ...
      size: {
        ...
        sm: "h-7 text-xs gap-1.5 px-3 has-[>svg]:px-2.5",
    ...
    <>
      ...
      >
        <div className="absolute top-0 left-0 z-0 h-full w-full rounded-full 
            ...
            shadow-[0_0_6px_rgba(0,0,0,0.03),0_2px_8px_rgba(0,0,0,0.06),inset_2px_2px_0.5px_-1px_rgba(255,255,255,0.9),inset_-2px_-2px_0.5px_-1px_rgba(0,0,0,0.1),inset_0_0_4px_2px_rgba(255,255,255,0.4)]
...
function LiquidGlassBadge({
  ...
  return (
    <div
      className={cn(
        "relative inline-flex items-center justify-center rounded-full px-4 py-1.5 text-[10px] font-sans font-bold tracking-widest uppercase text-neutral-800 transition-all duration-300 hover:scale-[1.02]",
        className
      )}
      {...props}
    >
      <div className="absolute top-0 left-0 z-0 h-full w-full rounded-full 
          ...
          shadow-[0_2px_10px_rgba(0,0,0,0.04),inset_1px_1px_1px_0px_rgba(255,255,255,0.95),inset_-1px_-1px_1px_0px_rgba(0,0,0,0.08),inset_0_0_6px_1px_rgba(255,255,255,0.5)] 
...
export { Button, buttonVariants, liquidbuttonVariants, LiquidButton, LiquidGlassBadge, MetalButton, GlassFilter }
